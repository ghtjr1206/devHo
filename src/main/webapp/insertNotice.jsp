...
<!--20240503_ym  에디터에서 수정하면 데이터가 직접 들어오는 장소 시작-->
	<div class="insert_container">
		<form action="insertNotice.ko" method="post" id="dataTransferForm" enctype="multipart/form-data">
			<table class="insert_table">
				<tr>
					<td class="insert_title">제목</td>
					<td>
						<input type="text" name="not_title" required placeholder="제목을 입력해 주세요">
					</td>
				</tr>
				<tr>
...
<!-- 		20240503_ym 사진아이콘 추가  종료-->
		...
		<div class="se2_conversion_mode">
			<button type="button" class="se2_inputarea_controller husky_seditor_editingArea_verticalResizer" ></button>
...
<!-- SE2 Markup End -->
			<div class="buttons">
				<button type="button" class="btn btn-primary btn-sm" onclick="submitContents();">새 글 등록</button>
