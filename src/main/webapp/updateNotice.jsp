...
<link href="${pageContext.request.contextPath }/css/ko_KR/smart_editor2_out.css" rel="stylesheet" type="text/css"><script type="text/javascript" src="${pageContext.request.contextPath }/js/lib/jindo2.all.js" charset="utf-8"></script>
