		...
		<input type="hidden" name="faq_no" value="${faq.faq_no}" readonly>
			<table class="insert_table">
				<tr>
					...
					<td>
						<input type="text" name="faq_title" required value="${faq.faq_title}">
					</td>
				</tr>
				<tr>
				<td class="insert_title">내용</td>
					<td>
						<textarea name="faq_content">${faq.faq_content}</textarea>
					</td>  		
				</tr>  		
			</table>		
			<div class="buttons">
				<button type="submit" class="btn btn-primary btn-sm">새 글 등록</button>
